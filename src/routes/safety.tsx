      ...
      <main className="mx-auto max-w-3xl px-6 py-14">
        ...
        <Section title="How to protect yourself and report">
          <ul className="list-disc space-y-2 pl-5">
            <li>
              <strong>Report in chat:</strong> ask @room to report a message, an image, a profile, a
              room or a community (for example “@room report this message as harassment”). You pick
            ...
            <li>
              If someone is in danger right now, contact your local emergency services. @room cannot

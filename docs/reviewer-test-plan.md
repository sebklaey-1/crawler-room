...
| P3  | "List public communities on Crawler Room"            | `communities` / `list_communities`   | none  | `action: "list_communities"`, `communities[]`                             |
...
| P7  | "Show me the organizations on Crawler Room"          | `communities` / `list_organizations` | none  | `action: "list_organizations"`, `organizations[]` without owner data      |
